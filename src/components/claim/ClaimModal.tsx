        ...
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              ...
              <TYPE.white fontWeight={700} fontSize={36}>
                <Trans>{unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} MISHKA</Trans>
              </TYPE.white>
            </CardSection>
            <Break />
            <CardSection gap="sm">
              {userClaimData?.flags?.isSOCKS && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">
                    <Trans>{SOCKS_AMOUNT} MISHKA</Trans>
                  </TYPE.subHeader>
                </RowBetween>
              )}
              ...
              {userClaimData?.flags?.isUser && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">
                    <Trans>{USER_AMOUNT} MISHKA</Trans>
                  </TYPE.subHeader>
                </RowBetween>
              )}
            </CardSection>
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              <Trans>
                As a member of the Mishka community you may claim MISHKA to be used for voting and governance.
                <br />
                <br />
                <ExternalLink href="https://uniswap.org/blog/uni">Read more about MISHKA</ExternalLink>
              </Trans>
            </TYPE.subHeader>
            <ButtonPrimary
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <ConfirmedIcon>
            {!claimConfirmed ? (
              ...
              <UniTokenAnimated width="72px" src={tokenLogo} alt="MISHKA" />
            )}
          </ConfirmedIcon>
